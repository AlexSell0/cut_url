...
// $links_count = $db -> query("SELECT COUNT(id) FROM `links`;") -> fetchColumn();
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<li class="nav-item">
						<?php 
							if(isset($_SESSION['user']['id']) && !empty($_SESSION['user']['id'])){
								echo '<a href="' . get_url("includs/logout.php") . '" class="btn btn-primary">Выйти</a>';

							}else{
								echo '<a href="' . get_url("login.php") . '" class="btn btn-primary">Войти</a>';
							}
						?>
						</li>
					</ul>
